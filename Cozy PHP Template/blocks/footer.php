				...
				<div class="row">
					...
					<div class="block col-sm-3">
						...
						<ul class="footer-links">
							<li><a href="properties-list.php">All Properties Available</a></li>
							<li><a href="agent-listing.php">Look for an Agent</a></li>
							<li><a href="agency-listing.php">Look for an Agency</a></li>
							<li><a href="pricing-tables.php">See our Pricing Tables</a></li>
						</ul>
					</div>
					<div class="block col-sm-3">
						...
						<ul class="footer-listings">
							<li>
								<div class="image">
									<a href="properties-detail.php"><img src="http://placehold.it/760x670" alt="" /></a>
								</div>
								<p><a href="properties-detail.php">Luxury Apartment with great views<span>+</span></a></p>
							</li>
							<li>
								<div class="image">
									<a href="properties-detail.php"><img src="http://placehold.it/760x670" alt="" /></a>
								</div>
								<p><a href="properties-detail.php">Stunning Villa with 5 bedrooms<span>+</span></a></p>
							</li>
							<li>
								<div class="image">
									<a href="properties-detail.php"><img src="http://placehold.it/760x670" alt="" /></a>
								</div>
								<p><a href="properties-detail.php">Recent construction with 3 bedrooms.<span>+</span></a></p>
							</li>
						</ul>
					</div>
				</div>
